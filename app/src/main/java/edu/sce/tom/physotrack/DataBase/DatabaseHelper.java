...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_IMAGE_RESULT = "image_result";
    ...
    public ArrayList<ImageResultViewer> getImageResultFromDBByDate(String date) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(
                TABLE_IMAGE_RESULT,
                null,
    ...
    public ArrayList<ImageResultViewer> getImageResultFromDBByExpressionAndDate(String date,String expr) {
        ...
        Cursor cursor = db.query(
                TABLE_IMAGE_RESULT,
                null,
                SESSION_DATE + "=?" + " AND " + EXPRESSION + "=?",
                new String[]{date,expr},
                null,
                null,
                null
        );
