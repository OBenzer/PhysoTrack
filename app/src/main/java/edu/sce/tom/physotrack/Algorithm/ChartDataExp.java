...
public class ChartDataExp {
    ...
    public LineDataSet getEyeToBrowDisstanceSet() {
        return eyeToBrowDisstanceSet;
    }

    public LineDataSet getEyeAreaSet() {
        return eyeAreaSet;
    }

    public LineDataSet getMouthDisstanceSet() {
        return mouthDisstanceSet;
    }

    public LineDataSet getInnerMouthAreaSet() {
        return innerMouthAreaSet;
    }

    public LineDataSet getOuterMouthAreaSet() {
        return outerMouthAreaSet;
    }

    public LineDataSet getMouthAngleSet() {
        return mouthAngleSet;
    }
}